  ...
  return (
    ...
    <ul>
        ...
        <li>Lưu trữ các hoạt động can thiệp mà gia đình đã và đang thực hiện trong trường hợp trẻ gặp khó khăn về phát triển và cần can thiệp
                , kèm theo bài đánh giá hiệu quả can thiệp ATEC. Cụ thể:
        <ul>
            <li>
            ...
            <li>
            ATEC là bảng kiểm đánh giá can thiệp tự kỷ, giúp cha mẹ và nhà chuyên môn theo dõi sự thay đổi toàn diện 
    ...
    <p>Hãy đăng ký tài khoản trên A365 để sử dụng các tính năng này nhé!</p>
</div>
  );
};
