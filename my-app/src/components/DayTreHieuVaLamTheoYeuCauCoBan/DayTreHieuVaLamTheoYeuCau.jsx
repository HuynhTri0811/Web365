...
import './DayTreHieuVaLamTheoYeuCau.css'

const DayTreHieuVaLamTheoYeuCau = () => {
  return (
    <div className='p-3 bg-light rounded shadow'>
      <h2>DẠY TRẺ TẬP TRUNG MỨC CAO</h2>
      <p>Ngày cập nhật: 22/10/2021</p>
      <div>
      ...
      <div>
            ...
            <p>
            <ul>
                <li>Tự kiểm soát bản thân: trẻ có thể bình tĩnh lại khi trẻ quá năng động, không thể ngồi yên một chỗ hoặc trẻ có thể tập trung, chú ý lại nếu trẻ bị mất tập trung.</li>
                <li>Kiểm soát được nhiều từ môi trường sống: như tiếng ồn lớn và/hoặc quá nhiều hình ảnh làm cho trẻ mất tập trung như áp phích hoặc tranh ảnh treo trên tường.</li>
                <li>Kiểm soát và hiểu được các nhiệm vụ có nhiều bước.</li>
                <li>Tham gia vào các hoạt động mà trẻ không thích, không quan tâm.</li>
            </ul>
            </p>
            <p style={{color:'red'}}>
            Những chiến lược nào có thể giúp trẻ vượt qua những khó khăn này?
            <ul >
            <li>Hãy chắc chắn rằng trẻ có thể tham gia vào các hoạt động vui chơi, tiêu tốn năng lượng trước khi tham gia vào những hoạt động cần sự chú ý và tập trung. Vì các hoạt động vui chơi giúp trẻ tiêu bớt năng lượng và hạn chế sự năng động ở trẻ.</li>
                <li>Bố trí môi trường đáp ứng các nhu cầu học tập của trẻ bằng cách loại bỏ những thứ có thể làm trẻ bị xao lãng.</li>
                <li>Đưa ra những hướng dẫn bằng lời ngắn gọn, rõ ràng kèm theo bảng biểu trực quan hoặc các dấu hiệu để trẻ hiểu các hướng dẫn.</li>
                <li>Nếu trẻ mất tập trung trong một trò chơi, hãy tạo cơ hội để trẻ chơi luân phiên. Bạn cũng có thể tham gia vào các hoạt động hoặc trò chơi đó để tăng động lực cho trẻ tham gia.</li>
                <li>Chia một hoạt động thành các hoạt động nhỏ hơn và sử dụng các phần thưởng như là một động lực để giúp trẻ tập trung.</li>
            </ul>
            </p>
            <p>
            ...
            <ul>
              <li>Bạn có thể chơi cùng với trẻ để vừa dạy trẻ khả năng tập trung, vừa mang lại niềm vui cho trẻ:</li>
            </ul>
            <p>
...
export default DayTreHieuVaLamTheoYeuCau;
