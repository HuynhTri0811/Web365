...
const DayTreGiaiQuyetTinhHuongCoBan = () => {
  return (
    <div className='p-3 bg-light rounded shadow'>
      <h2>DẠY TRẺ GIẢI QUYẾT TÌNH HUỐNG ĐƠN GIẢN</h2>
      <p>Ngày cập nhật: 09/02/2021</p>
      <div>
      ...
      <div>
          ...
          <ul>
            <li>Tìm ra được vấn đề trẻ đang gặp phải</li>
            <li>Đưa ra được các cách giải quyết</li>
            <li>Phân tích để biết ưu nhược điểm các cách giải quyết</li>
            <li>Lựa chọn một giải pháp để thực hiện</li>
            <li>Đánh giá đã giải quyết được vấn đề chưa, nếu chưa, kiên trì thử phương án khác</li>
            <li>Mức cao hơn nữa là phòng ngừa để các vấn đề không tiếp tục xảy ra trong tương lai</li>
          </ul>
          <p>
...
export default DayTreGiaiQuyetTinhHuongCoBan;
